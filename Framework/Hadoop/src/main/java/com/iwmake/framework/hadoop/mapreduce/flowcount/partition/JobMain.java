...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        TextInputFormat.addInputPath(job, new Path("file:///Users/ydy/Desktop/input/flowcount_partition"));
        ...
        // 四(排序)、五，规约、六(分组) Shuffle阶段采用默认方式
        ...
        // 设置分区 应该设置reduce task个数
        job.setNumReduceTasks(3);

        // 八、设置输出类型
        job.setOutputFormatClass(TextOutputFormat.class);
        // 设置输出路径
        TextOutputFormat.setOutputPath(job, new Path("file:///Users/ydy/Desktop/out/flowcount_partition/f_out"));
